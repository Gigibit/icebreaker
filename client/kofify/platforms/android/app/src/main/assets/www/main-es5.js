...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_componentsSelectPlanSelectPlanComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SelectPlanComponent(platform, iap, authService, modalCtrl, toastService, userService) {
                    ...
                    this.iap.buy(selectedPlanId).then(function (data) {
                      _this10.iap.consume(data.productType, data.receipt, data.signature).then(function () {
                        _this10.userService.finalizePayment(data).subscribe(function (data) {
                          _this10.authService.currentUserValue.credits = data && data['credit'] && data['credit']['credits'];

                          _this10.authService.contextRefresh(_this10.authService.currentUserValue);
                        });
                      });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/luigichougrad/archimedia/projects/kokify/icebreaker/client/kofify/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
