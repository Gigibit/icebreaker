      ...
      _createClass(HomePage, [{
        ...
        value: function getGeoencoder(latitude, longitude) {
          ...
          this.nativeGeocoder.reverseGeocode(latitude, longitude, this.geoencoderOptions).then(function (result) {
            ...
            _this4.userService.updateAddress(_this4.geoAddress, latitude, longitude).subscribe(function (response) {
              return console.log(response);
            });
          }).catch(function (error) {
            console.log(error);

            _this4.userService.updateAddress(null, latitude, longitude).subscribe(function (response) {
              return console.log(response);
            });
          });
        }
